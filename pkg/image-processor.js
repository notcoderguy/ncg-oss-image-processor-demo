...
export class ImageProcessor {
     ...
     */
    set quality(quality) {
        wasm.imageprocessor_set_quality(this.__wbg_ptr, quality);
    }
    /**
     * @param {number | null} [width]
     * @param {number | null} [height]
     */
    // set max_dimensions(width, height) {
    //     wasm.imageprocessor_set_max_dimensions(this.__wbg_ptr, isLikeNone(width) ? 0x100000001 : (width) >>> 0, isLikeNone(height) ? 0x10000001 : (height) >>> 0);
    // }
    /**
    ...
    process_image(input_data) {
        ...
        const ret = wasm.imageprocessor_process_image(this.__wbg_ptr, ptr0, len0);
        if (ret[2]) {
     ...
     * @returns {any}
     */
    get_image_info(input_data) {
        const ptr0 = passArray8ToWasm0(input_data, wasm.__wbindgen_malloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.imageprocessor_get_image_info(this.__wbg_ptr, ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
    ...
    process_batch(images) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.imageprocessor_process_batch(this.__wbg_ptr, ptr0, len0);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return takeFromExternrefTable0(ret[0]);
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('image-processor_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
